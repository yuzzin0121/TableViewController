    ...
    static let mockChatList: [ChatRoom] = [
        ChatRoom(chatroomId: 1,
                 ...
                 chatList: [
                    ...
                    Chat(user: .jack,
                         date: "2024-01-13 22:38",
                         message: "화이팅!!"),
                    Chat(user: .den,
                         date: "2024-01-13 23:42",
                         message: "열심히 하고 있습니다!!"),
                 ]
                ),
        ...
        ChatRoom(chatroomId: 5,
                 ...
                 chatList: [
                    ...
                    Chat(user: .den,
                         date: "2024-01-13 11:31",
                         message: "어디가셨어요~~"),
                    Chat(user: .den,
                         date: "2024-01-14 15:32",
        ...
        ChatRoom(chatroomId: 7,
                 ...
                 chatList: [
                    ...
                    Chat(user: .simsim,
                         ...
                         message: "아닛 주말에 과제라닛"),
                    Chat(user: .user,
                         date: "2024-01-13 09:36",
                         message: "..."),
                    Chat(user: .simsim,
                         date: "2024-01-13 09:37",
                         message: "아닛 주말에 과제라닛"),
                 ]
                ),
    ]
